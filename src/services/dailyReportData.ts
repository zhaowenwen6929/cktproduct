...
const DAILY_REPORT_ROWS: DailyReportRawRow[] = [
  {
    date: '2026-08-12',
    actualPaidCount: 680,
    actualPaymentAmountFen: 4742135,
    backendPaidCount: 23,
    backendPaymentAmountFen: 8900,
    canvasPaidCount: 9,
    canvasPaymentAmountFen: 82610,
    ecommercePaidCount: 1,
    ecommercePaymentAmountFen: 6000,
    mainDesignDownloadCount: 86327,
    canvasDownloadCount: 841,
    ecommerceDownloadCount: 207,
  },
  {
    date: '2026-08-11',
    actualPaidCount: 707,
