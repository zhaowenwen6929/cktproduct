        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/30 p-5" onClick={() => setDocumentOpen(false)}>
          <div className="max-h-[86vh] w-[520px] overflow-auto rounded-xl bg-white p-4 shadow-2xl" onClick={(event) => event.stopPropagation()}>
            ...
            <div className="mt-3 rounded-[12px] bg-[#f7f8fb] p-3 text-[13px] text-gray-700">
              ...
              <div className="group relative pt-3"><div className="mb-1 text-[12px] text-gray-400">内容要点</div>本文为文档内容摘要，已提取主题、文案、品牌信息及视觉要求等关键内容。文档中的核心信息将用于后续规划与设计生成。<div className="absolute right-0 top-2 flex gap-1 opacity-0 transition-opacity group-hover:opacity-100"><button type="button" aria-label="放大内容要点" className="rounded-md bg-white p-1 text-gray-600 shadow-sm hover:text-black"><Maximize2 size={13}/></button><button type="button" aria-label="添加内容要点" className="rounded-md bg-white p-1 text-gray-600 shadow-sm hover:text-black"><Plus size={14}/></button></div></div>
            </div>
